...
atacmapplot_link = '''"QC/''' + outpre + '''_map.png"'''
...
report_html_instance = report_html_temp % {"outprefix":outpre, "atacfastqdir":atacfastqdir, "species":species, "platform":platform, "fragment":fragplot_link, "atacmap":atacmapplot_link, "frip":fripplot_link, "peakcluster":peakcluster_link, "rpannotate":rpannotate_link}
