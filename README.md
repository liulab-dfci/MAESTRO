...
### v1.0.0
	* Release MAESTRO.
### v1.0.1
    * Provide docker image for easy installation, check out https://hub.docker.com/repository/docker/winterdongqing/maestro. Note, the docker do not include cellranger/cellrangerATAC, as well as the corresponding genome index. Please install cellranger/cellranger ATAC follow the installation instructions.
