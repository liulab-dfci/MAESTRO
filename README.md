...
### v1.5.0
* Add fast-scatac subcommamd for processing scATAC-seq with chromap as default alignment tool.
* Fix bug in fragments deduplication in single sample processing pipeline.
