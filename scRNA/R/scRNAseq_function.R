...
hg38_genome = read.delim(paste0(srcdir, "annotations/hg38_mart_export.txt"), check.names = FALSE)
mm10_genome = read.delim(paste0(srcdir, "annotations/mm10_mart_export.txt"), check.names = FALSE)
