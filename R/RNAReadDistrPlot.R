...
#'
#' @param bamstat.filepath Path of the scRNA-seq mapping summary file generated by \code{MAESTRO}. 
#' For 10x-genomics, the file is metrics_summary.csv. For other platform, the file is 
#' @param readdistr.filepath Path of the scRNA-seq read distribution file generated by \code{MAESTRO}.
#' @param name Name for the output read distribution plot.
#' @param platform Denote platform of the scRNA-seq data, available options are "Smartseq2",
#' "10x-genomics","Dropseq". Default platform is "10x-genomics".
#'
#' @author Dongqing Sun, Chenfei Wang
#'
#' @export

RNAReadDistrPlot <- function(bamstat.filepath, readdistr.filepath, name, platform){
  require(ggplot2)
  require(cowplot)
  RCB_blue = "#2166AC"
  RCB_red = "#B2182B"
  
  if(platform == "Smartseq2" | platform == "Dropseq"){
