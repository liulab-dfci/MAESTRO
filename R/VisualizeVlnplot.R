...
#' VisualizeVlnplot(genes = pbmc.tfs, cluster = "0", type = "RNA", SeuratObj = pbmc$RNA, ncol = 5, width = 6, height = 3, name = "PBMC.scRNA.tf")
#'
#' # Genes of interest
#' VisualizeVlnplot(genes = c("MS4A1","FCGR3A","CD3D","GZMB"), type = "RNA", SeuratObj = pbmc$RNA, ncol = 4, width = 6, height = 2.5, name = "PBMC.scRNA.genes")
#'
#' @export
