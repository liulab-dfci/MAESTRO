...
fastqdir: /homes/cwang/projects/MAESTRO/snakemake/ATAC/10X/10X_PBMC_10K
...
fastqprefix: 10k_fastqs
# Species to use [GRCh38, mmu] (GRCh38 for human and mmu for mouse)
species: GRCh38
# Platform of single cell RNA-seq [Microfludics, 10x-genomics, sci-ATAC-seq]
platform: 10x-genomics
# The prefix of output files
outprefix: 10X_PBMC_10K
# Number of cores to use
cores: 8
# annotation to run giggle
rabitlib: /homes/cwang/annotations/giggle

# Reference genome 
genome:
  # Genome index directory for BWA
  mapindex: /homes/cwang/annotations/refdata-cellranger-atac-hg38-1.0.0/fasta
